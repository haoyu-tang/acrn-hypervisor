...
#define VSBI_ACRN_IMPID 0x12U /* FIXME: once official ID confirmed */
#define VSBI_ACRN_MVENDORID 0x1U /* dummy MVENDORID for guest VM */
#define VSBI_ACRN_MARCHID 0x1U /* dummy MARCHID for guest VM */
#define VSBI_ACRN_MIMPID 0x12U /* dummy MIMPID for guest VM */
